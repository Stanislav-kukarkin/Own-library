...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.createModal = function ({
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    modal.setAttribute('id', this[i].getAttribute('data-target').slice(1)); //btns = {count: num, setting: [[text, className=[], close, cb]]}
...
/* harmony import */ var _modules_action__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/action */ "./src/js/lib/modules/action.js");
/* harmony import */ var _modules_affect__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/affect */ "./src/js/lib/modules/affect.js");
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.addClass = function (...classNames) {
  //spread разворачивает все имена класса которые были переданы внутрь функции
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.get = async function (url, dataTypeAnswer = 'json') {
  let res = await fetch(url); //c помощью await полностью дожидаемся фэтч запроса, когда запрос завершился помещаем этот промис в res
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').click(() => Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').createModal({
  ...
  btns: {
    ...
    }], ['Another button', ['btn-dark', 'ml-10'], false, () => {
      alert('hi world');
    }]]
  }
}));
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])().get('https://jsonplaceholder.typicode.com/todos/1').then(res => {
  console.log(res);
